...
3. [PPIXpress](https://sourceforge.net/projects/ppixpress/) was used to generate patient specific PPIN using the bash command: 
...
5. Perturbed edges appearing in atleast two cancer types were merged together to obtain pan-cancer gain and loss profiles (Supplementary Tables 14-15)
